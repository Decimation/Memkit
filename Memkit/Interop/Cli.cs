...
namespace Memkit.Interop
{
	...
	{
		private static FileInfo RunSymCheck(FileInfo dll, DirectoryInfo output)
		{
			...
			string[] stdOut = ShellOutput(fullCmd).Output;
		...
		public static CommandResult ShellOutput(string cmd)
		{
			...
			return new CommandResult(cmd, list.ToArray(), proc.ExitCode);
		}
